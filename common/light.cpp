...
Light::Light(GLFWwindow* window, 
    ...
    lightSpeed = 0.1f;
    targetPosition = glm::vec3(3.5, 0.1, 3.5);


    projectionMatrix = ortho(-5.0f, 5.0f, -5.0f, 5.0f, nearPlane, farPlane);
    orthoProj = true;
}
